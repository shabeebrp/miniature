...
(cd ../../../main && go build $RACE master.go) || exit 1
(cd ../../../main && go build $RACE worker.go) || exit 1
...
gtimeout -k 2s 180s ../../../main/master ../pg*txt &

# give the master time to create the sockets.
sleep 1

# start multiple workers.
gtimeout -k 2s 180s ../../../main/worker ../mrapps/wc.so &
gtimeout -k 2s 180s ../../../main/worker ../mrapps/wc.so &
gtimeout -k 2s 180s ../../../main/worker ../mrapps/wc.so &
...
# start multiple workers
gtimeout -k 2s 180s ../../../main/worker ../mrapps/indexer.so &
gtimeout -k 2s 180s ../../../main/worker ../mrapps/indexer.so
...
gtimeout -k 2s 180s ../../../main/worker ../mrapps/mtiming.so &
gtimeout -k 2s 180s ../../../main/worker ../mrapps/mtiming.so
...
gtimeout -k 2s 180s ../../../main/worker ../mrapps/rtiming.so &
gtimeout -k 2s 180s ../../../main/worker ../mrapps/rtiming.so
...
rm -f mr-done
(gtimeout -k 2s 180s ../../../main/master ../pg*txt ; touch mr-done ) &
sleep 1

# start multiple workers
gtimeout -k 2s 180s ../../../main/worker ../mrapps/crash.so &
